<template>
  <div
    class="relative w-full overflow-hidden leading-none shrink-0 origin-top rotate-180 -mt-28 z-10"
...
const props = defineProps({
  /** Fill color of the wave (section above). Keys from @/theme/segmentColors */
  fill: {
    type: String,
    default: 'white',
  },
  /** Background of the strip below the wave. Keys from @/theme/segmentColors */
  background: {
    type: String,
    default: 'white',
  },
...
const backgroundClass = computed(
  () => segmentColorClasses[props.background]?.bg ?? 'bg-white',
)
